...
color.green = '#00ff00'
color.seagreen = '#54ff9f'
color.blue = '#0000ff'
color.royalblue = '#4876ff'
color.dodgerblue = '#1e90ff'
color.steelblue = '#63b8ff'
...
theme.border_focus  = color.darkgray
...
theme.awesome_icon = "~/.config/awesome/logo.png"
